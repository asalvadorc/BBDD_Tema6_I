...
**3** Traure el codi d'article, la descripció, preu i preu incrementat en un
...
**4** Traure la informació dels clients amb el següent format (ha d'anar tot
en una columna):
...
**16** Comptar el número de vegades que l'article **L76104** entra en les
...
**36** Traure els resultats de la consulta **6.33** ordenats pel total de la
